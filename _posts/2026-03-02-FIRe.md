...
4. F~o~ -baseline fluorescence, some reaction centers are open and some are closed started conditions
5. F~m~ - saturating light so all reaction centers close and all energy is released as fluorescence
6. F~v~ - variable fluorescence
7. F~v~/F~m~ - main parameter, quantum efficiency of photosystem 2
...
9. As part of energy photochemistry, some is lost as heat and as fluorescence 
    ...
    C. Thermal dissipation (photoacoustics- impossible to use in the ocean), Fluroenses, Photosynthetic efficacy= 1 (energy budget)
...
12. At the end of the second impulse, turn off and look at the relaxation of photosystem II of fm to Fo (using large flashes of light) - longer time scale (mili seconds)
...
3. Initial slope and maximum photosynthesis = complete picture
    A. The initial slope is controlled by F~v~/F~m~- maximum quantum yield f photochemistry in PSII, controlled by photosynthetic turnover rates - how fast the entire chain of secondary photochemical reactions, rate limiting process - limits and controls the amount of light absorbed 
...
2. This is the reason we measure F~v~/F~m~ over heat dissipation 
...
3. NPQ affects F~m~, F’, and F~o~- these all become close to each other when they get closer
...
1. Photosynthetic rates are not measured directly from F~v~ signals, the rates are models
...
### Using F~v~/F~m~
1. F~v~/F~m~ could be used as an indicator of nutrient stress
     A. Relationship better F~v~/F~m~ and growth rates is highly non-linear
     B. Not strong
...
3. Conclusion
    A. think beyond F~v~/F~m~ and look at all photosynthetic parameters 
    B. Use a combination of amplitude-based and kinetic analyses in the new mimi-FIRE to offer a significant improvement in the capability of Fv for assessment of absolute photosynthetic rates, growth, NPP, and relation to N and Fe stress in the ocean 
      1. F~m~ can be a proxy for chlorophyll or algae- yes but you may have saturation at a certain point 
      2. F~o~ can be used to determine inactive reaction centers
      3. F~v~, F~m~, F~v~/F~m~
      4. Sigma - cross-sectional photosynthetic rates
      5. Tau - photosynthetic turnover 
    C. If coral is acclimated to low light, Pmax may not be 
